            ...
            <div className="flex justify-between">
              {data.map((el) => (
                <div className="flex flex-col items-start gap-px" key={el.title}>
                  <p className="font-normal text-[#828282] text-xs capitalize">{el.title}</p>
                  <div className="flex items-center gap-1">
                    <p className="font-bold text-lg text-neutral-800 leading-[normal]">{el.value}</p>
                    {el.valueComponent}
                  </div>
                  <p className="font-normal text-[#828282] text-[10px] uppercase leading-[normal]">
                    {el.additionalValue}
                  </p>
                </div>
              ))}
